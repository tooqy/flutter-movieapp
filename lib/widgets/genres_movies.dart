...
import 'package:movie_app/bloc/get_movies_by_genres_bloc.dart';
...
class _GenreMoviesState extends State<GenreMovies> {
  ...
  void initState() {
    super.initState();
    moviesByGenreBloc..getMovisByGenres(genreId);
  }
    ...
    return StreamBuilder<MovieResponse>(
      ...
      builder: (context, AsyncSnapshot<MovieResponse> snapshot) {
        if (snapshot.hasData) {
          ...
          return _buildNMovieByGenreWidget(snapshot.data);
  ...
  Widget _buildNMovieByGenreWidget(MovieResponse data) {
